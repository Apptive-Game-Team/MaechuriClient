      ...
      <div className="result-container">
        ...
        <div className="result-scores">
          <div className="score-item">
            ...
            <div className="score-value">{(result?.culpritScore ?? 0).toFixed(1)}%</div>
          </div>
          <div className="score-item">
            <div className="score-label">Reasoning Score</div>
            <div className="score-value">{(result?.reasoningScore ?? 0).toFixed(1)}%</div>
          </div>
          <div className="score-item total">
            <div className="score-label">Total Score</div>
            <div className="score-value">{(result?.totalScore ?? 0).toFixed(1)}%</div>
          </div>
        </div>
